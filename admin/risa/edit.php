...
<body>
	...
	<div class="container">
		<div class="content">
			...
			$sql = mysqli_query($con, "SELECT * FROM employees WHERE national_id='$national_id'");
			...
			if(isset($_POST['save'])){
				...
				$update = mysqli_query($con, "UPDATE employees SET employee_name='$employee_name', birth_place='$birth_place', birth_date='$birth_date', address='$address', telephone='$telephone', department='$department', status='$status' WHERE national_id='$national_id'") or die(mysqli_error());
				if($update){
