...
<body>
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand visible-xs-block visible-sm-block" href="">Data employees</a>
				<a class="navbar-brand hidden-xs hidden-sm" href="">Data employees</a>
			</div>
	...
	<div class="container">
		<div class="content">
			<h2>Data employees &raquo; Ganti Password</h2>
			<hr />
			...
			if(isset($_POST['ganti'])){
				...
				$cek = mysqli_query($con, "SELECT * FROM employees WHERE national_id='$national_id' AND password='$password'");
				if(mysqli_num_rows($cek) == 0){
					...
					if($password1 == $password2){
						if(strlen($password1) >= 6){
							$pass = md5($password1);
							$update = mysqli_query($con, "UPDATE employees SET password='$pass' WHERE national_id='$national_id'");
							if($update){
