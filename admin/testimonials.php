...
<head>
	...
	<title>Glowreea's Confectionery Corner | Manage testimonials   </title>
						...
						<div class="panel panel-default">
							...
							<?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<?php $sql = "SELECT users.name,testimonial.UserEmail,testimonial.Testimonial,testimonial.PostingDate,testimonial.status,testimonial.id from testimonial join users on users.Emailid=testimonial.UserEmail";
$query = $dbh -> prepare($sql);
$query->execute();
