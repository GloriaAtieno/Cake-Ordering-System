...
<head>
	...
	<title> Glowreea's Confectionary Corner | Admin Dashboard</title>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-info text-light">
												<div class="stat-panel text-center">
													<?php
														$sql01 ="SELECT `invoice_number` from `orders` GROUP BY `cart_id`";
														$stmt01= $con->prepare($sql01);
														$stmt01->execute();
														$result = $stmt01->get_result();
														$rows = $result->num_rows;
													?>
													<div class="stat-panel-number h1 "><?php echo htmlentities($rows);?></div>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-warning text-light">
												<div class="stat-panel text-center">
													<?php
														$sql5 ="SELECT employee_name from employees ";
														$query5= $dbh -> prepare($sql5);
														$query5->execute();
														$results5=$query5->fetchAll(PDO::FETCH_OBJ);
