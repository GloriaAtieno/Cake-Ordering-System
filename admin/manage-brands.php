...
<head>
	...
	<title>Glowreea's Confectionary Corner | Admin Manage Category   </title>
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				<div class="row">
					...
					<button onClick="window.print()">Print Categories</button>
...
{				?>	
										<tr>
											...
											<td>
												<?php if ($result->updationDate==="0000-00-00 00:00:00"){ ?>
													No recent update
												<?php }else{ ?>
