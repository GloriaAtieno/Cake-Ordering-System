...
$id=$_GET['id'];
$sql="update subcategory set categoryid=:category,subcategory=:subcat,updationDate=:updationDate where id=:id";
...
<head>
	...
	<title>Glowreea's Confectionery Corner | Edit Subcategory</title>
