<nav class="ts-sidebar">
	<ul class="ts-sidebar-menu">
		...
		<li>
			<a href="#"><i class="fa fa-sitemap"></i> cake</a>
			<ul>
		...
		<li>
			...
			<ul>
				<li><a href="customer_reports.php"><i class="fa fa-users"></i> Customer Reports</a></li>
				<li><a href="cake_reports.php"><i class="fa fa-file"></i> Cake Reports</a></li>
			</ul>
		</li>
	</ul>
</nav>
